...
public class a1Controller {
    ...
    void memDeletClick(ActionEvent event) {
    	...
    	try {
    		...
    		FXMLLoader loader = new FXMLLoader(
    				a1Controller.class.getResource("/yaksa/member/fxml/mypage/a2_IdDelet.fxml")
    				);
    ...
    void memInfoUpdateClick(ActionEvent event) {
    	try {
    		...
    		FXMLLoader loader = new FXMLLoader(
    				a1Controller.class.getResource("/yaksa/member/fxml/mypage/a11_infoUpdate.fxml")
    				);
    		Parent addRoot = loader.load();
    ...
    void memVisitClick(ActionEvent event) {
    	try {
			...
			FXMLLoader loader = new FXMLLoader(
    				a1Controller.class.getResource("/yaksa/member/fxml/mypage/a4_visit.fxml")
    				);
