...
public class MainController {
    ...
    void findPharm(ActionEvent event) {
    	try {
			Parent childroot = FXMLLoader.load(getClass().getResource("../../fxml/map/YKSearch.fxml"));
    ...
    void mypage(ActionEvent event) {
    	try {
    		...
    		FXMLLoader loader = new FXMLLoader(
    				getClass().getResource("../../fxml/mypage/a1_pMyPage.fxml")
    				);
    ...
    void searchMedi(ActionEvent event) {
    	try {
			Parent childroot = FXMLLoader.load(getClass().getResource("../../fxml/pillSearch/SearchPill.fxml"));
    		outerBoarderPane.setCenter(childroot);
		} catch (IOException e) {
			e.printStackTrace();
		}
    ...
    void showReceipt(ActionEvent event) {
    	try {
			Parent childroot = FXMLLoader.load(getClass().getResource("../../fxml/prescription/Receipt.fxml"));
    		outerBoarderPane.setCenter(childroot);
		} catch (IOException e) {
			e.printStackTrace();
		}
