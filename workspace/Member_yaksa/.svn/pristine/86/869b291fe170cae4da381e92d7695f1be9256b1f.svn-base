...
public class calendarController {
    ...
    void addclcik(ActionEvent event) throws IOException {
    	...
    	//새창 
    	Parent add = FXMLLoader.load(getClass().getResource("../../fxml/join/inputCalendar.fxml"));
                	...
                	clickDate = ((Label)(((VBox)(ee.getSource())).getChildren().get(1))).getText();
					 ...
					 if(e.getClickCount()==2) {
						 ...
						 try {
							 ...
							 FXMLLoader loader = new FXMLLoader(calendarController.class.getResource("../../fxml/join/detailCalendar.fxml"));
