...
public class ContYKDetail {
	...
	void PrecSend(ActionEvent event) {
		...
		try {
			...
			Parent childRoot = FXMLLoader.load(getClass().getResource("/yaksa/member/fxml/prescription/PresUpload.fxml"));
...
//								
					...
					FXMLLoader detail = new FXMLLoader(
							ContYKSearch.class.getResource("/yaksa/member/controller/map/wait/WaitScreen.fxml"));
					Parent childRoot;
