package yaksa.publicChatClient.ui.controller;
...
import yaksa.publicChatClient.connector.ChatServerConnector;
import yaksa.publicChatClient.observerImpl.ChatObserverImpl;
...
//        System.out.println(username);
        ...
        try {
            ...
            controller= ChatServerConnector.getServerConnector().getController(); // 유저가 이미 바운드된 것을 가져온다?
...
//            String path= new File(String.format("resources/user-images/%s.png", "user")).toURI().toString();
...
//            containerPane.getStyleClass().add("online-user-container");
            ...
            try{
                String path= new File(String.format("resources/user-images/%s.png", client.getUsername())).toURI().toString();
//            	String path= new File("resources/user-images/user.png").toURI().toString();
                img.setFill(new ImagePattern(new Image(path)));
