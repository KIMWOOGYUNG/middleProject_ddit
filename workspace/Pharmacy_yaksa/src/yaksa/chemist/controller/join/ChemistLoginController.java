...
public class ChemistLoginController {
    ...
    void Join(ActionEvent event) {
    	try {
    		...
    		Parent childRoot = FXMLLoader.load(ChemistLoginController.class.getResource("/yaksa/chemist/fxml/join/Agree.fxml"));
...
//			loginCheck = service.LoginChemist(pw);
			...
			if(loginChemist != null) {
				...
				Stage dialog = new Stage();
				FXMLLoader insert = new FXMLLoader(ChemistLoginController.class.getResource("/yaksa/chemist/fxml/main/Main.fxml"));
    ...
    void LookId(ActionEvent event) {
    	try {
	    	...
	    	Stage dialog = new Stage();
			Parent childRoot = FXMLLoader.load(ChemistLoginController.class.getResource("/yaksa/chemist/fxml/join/SearchChemistId.fxml"));
			dialog.initStyle(StageStyle.TRANSPARENT); //
    		Scene childScene = new Scene(childRoot);
    		childScene.setFill(Color.TRANSPARENT);	//
    ...
    void LookPwd(ActionEvent event) {
    	try {
	    	...
	    	Stage dialog = new Stage();
			Parent childRoot = FXMLLoader.load(ChemistLoginController.class.getResource("/yaksa/chemist/fxml/join/SearchChemistPw.fxml"));
			dialog.initStyle(StageStyle.TRANSPARENT); //
    		Scene childScene = new Scene(childRoot);
    		childScene.setFill(Color.TRANSPARENT);	//
