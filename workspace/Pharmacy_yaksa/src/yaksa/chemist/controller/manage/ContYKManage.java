package yaksa.chemist.controller.manage;
...
import yaksa.chemist.service.manage.ManageServiceImpl;
...
//   public class JavaConnector{
//      public void toLowerCase(String zipcode, String addr) {
//         SessionVO.loginChemist.getPharm_id();
//         ChemistServiceImpl service = ChemistServiceImpl.getInstance();
//         ZCField.setText(zipcode);
//         Add1Field.setText(addr);
//         
//         SessionVO.loginChemist.setPharm_zip_code(Integer.parseInt(zipcode));
//         SessionVO.loginChemist.setPharm_add1(addr);
//         
//         service.updateZipNum(SessionVO.loginChemist);
//      }
//      
//   }
...
//      webEngine.load("http://localhost/ykMap/kakaozipcode.html");
   ...
   void DeleteFin(ActionEvent event) {
      ...
      String pharmID = SessionVO.loginChemist.getPharm_id();
...
//       pvo = new PharmVO();
   ...
   void UpdateFinish(ActionEvent event) {
      ...
      String input_id = IDField.getText();
      ...
      if (input_id.isEmpty()||input_pw.isEmpty() || input_ch.isEmpty() || input_em1.isEmpty() || input_em2.isEmpty()||input_tel.isEmpty()) {
      ...
      pvo.setPharm_id(IDField.getText());
   ...
   void pharmGetAll() {
      List<PharmVO> pList = service.getAllYK(SessionVO.loginChemist.getPharm_id());
