    ...
    void clickTable(MouseEvent event) {
    	if(table.getSelectionModel().isEmpty()) {
			...
			try {
				...
				FXMLLoader fxml =  new FXMLLoader(getClass().getResource("/yaksa/chemist/fxml/prescription/PrescriptPreview2.fxml"));
				Parent childRoot = fxml.load();
				Scene childScene = new Scene(childRoot);
				
				PreviewController2 prev = fxml.getController();
