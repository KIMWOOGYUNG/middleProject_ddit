...
public class MainController implements ObYakSaBoard {
    ...
    void managePres(ActionEvent event) {
    	try {
			Parent childroot = FXMLLoader.load(getClass().getResource("/yaksa/chemist/fxml/prescription/PrescriptManage.fxml"));
    ...
    void gotoMain(MouseEvent event) {
    	try {
			Parent childroot = FXMLLoader.load(getClass().getResource("/yaksa/chemist/fxml/main/MainCenter.fxml"));
    		outerBoarderPane.setCenter(childroot);
		} catch (IOException e) {
			e.printStackTrace();
		}
    ...
    void statics(ActionEvent event) {
    	try {
			Parent childroot = FXMLLoader.load(getClass().getResource("/yaksa/chemist/fxml/chart/YKChart.fxml"));
    		outerBoarderPane.setCenter(childroot);
		} catch (IOException e) {
			e.printStackTrace();
		}
    ...
    void managePharm(ActionEvent event) {
    	try {
			Parent childroot = FXMLLoader.load(getClass().getResource("/yaksa/chemist/fxml/manage/YKManage.fxml"));
    		outerBoarderPane.setCenter(childroot);
		} catch (IOException e) {
			e.printStackTrace();
		}
    ...
    void manageInven(ActionEvent event) {
    	try {
			Parent childroot = FXMLLoader.load(getClass().getResource("/yaksa/chemist/fxml/inventory/Inventory.fxml"));
    		outerBoarderPane.setCenter(childroot);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public boolean Popup(String ClientName) throws RemoteException {
		...
		Platform.runLater( ()->{
			...
			try {
				...
				FXMLLoader fxml = new FXMLLoader(MainController.class.getResource("/yaksa/chemist/controller/main/MainAccept.fxml"));
				root = fxml.load();
