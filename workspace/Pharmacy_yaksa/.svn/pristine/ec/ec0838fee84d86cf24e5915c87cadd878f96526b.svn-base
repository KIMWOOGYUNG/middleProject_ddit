...
public class PharmVo {
	...
	private String pharm_zip_code;
	private String pharm_add1;
	private String pharm_add2;
	private String pharm_tel;
	private String pharm_starrate;
	private String pharm_totalsale;
	private String pharm_available;
	...
	public String getPharm_zip_code() {
		return pharm_zip_code;
	}
	public void setPharm_zip_code(String pharm_zip_code) {
	...
	public String getPharm_starrate() {
		return pharm_starrate;
	}
	public void setPharm_starrate(String pharm_starrate) {
		this.pharm_starrate = pharm_starrate;
	}
	public String getPharm_totalsale() {
		return pharm_totalsale;
	}
	public void setPharm_totalsale(String pharm_totalsale) {
