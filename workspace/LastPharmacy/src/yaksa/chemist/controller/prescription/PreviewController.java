...
public class PreviewController {
    ...
    void accept(ActionEvent event) {
    	try {
			...
			FXMLLoader fxml = new FXMLLoader(getClass().getResource("../../fxml/prescription/Accept.fxml"));
    ...
    void reject(ActionEvent event) {
    	try {
			Stage dialog = new Stage();
			dialog.initModality(Modality.WINDOW_MODAL);
			FXMLLoader fxml = new FXMLLoader(getClass().getResource("../../fxml/prescription/Reject.fxml"));
			Parent childRoot = fxml.load();
			dialog.initStyle(StageStyle.TRANSPARENT);
    ...
    void imgZoom(MouseEvent event) {
    	try {
			...
			dialog.initModality(Modality.WINDOW_MODAL);
			//dialog.initStyle(StageStyle.TRANSPARENT);
    		FXMLLoader fxml = new FXMLLoader(getClass().getResource("../../fxml/prescription/PresZoom.fxml"));
			Parent childRoot = fxml.load();
    ...
    void inventory(ActionEvent event) {
    	try {
    		...
    		FXMLLoader fxml = new FXMLLoader(getClass().getResource("../../fxml/prescription/Inventory.fxml"));
			Parent childroot = fxml.load();
    ...
    void wrtPres(ActionEvent event) {
    	try {
    		...
    		FXMLLoader fxml =  new FXMLLoader(getClass().getResource("../../fxml/prescription/PresOfChemi.fxml"));
			Parent childRoot = fxml.load();
