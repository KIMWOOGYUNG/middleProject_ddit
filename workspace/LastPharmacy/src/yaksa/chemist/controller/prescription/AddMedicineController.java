...
public class AddMedicineController {
    ...
    void addReceipt() {
    	if(total_admin.getText().equals("") || prladmin.getText().equals("") || admin_day.getText().equals("") || taking_time.getText().equals("")) {
    		...
    		System.out.println("1"+presVo.getPhar_file()); 
    		...
    		int total_cnt = Integer.parseInt(prladmin.getText()) * Integer.parseInt(admin_day.getText()) * Integer.parseInt(total_admin.getText());
    		rcVo.setPhpres_salecnt(total_cnt);
    		PreviewController.rctList.add(rcVo);
    		System.out.println(PreviewController.rctList);
